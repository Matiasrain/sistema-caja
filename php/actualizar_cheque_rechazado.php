...
$cob_rech = $_POST['fecha-cob'];
$obs_cheque = $_POST['obs_che'];
...
//$sql = "UPDATE cheques SET (COD_BCO, END_CHE, COD_BCO, SUC_BCO, NRO_CHE, FEC_VTO, IMP_CHE, FIR_CHE, CUIT_CHE, TIP_VAL,DES_CHE,FECH_RECH,OBS_RECH)
  ...
  $sql = "UPDATE cheques SET COB_RECH = '$cob_rech' WHERE NRO_CHE = '$nroChe'";
...
if ($conn->query($sql) === TRUE) {
  ...
  window.location.href = '../cobranza_rechazados.html';
