...
// $sql = "SELECT * FROM cheques WHERE FEC_RECH IS NOT NULL AND FEC_RECH <> '0000-00-00'";
$sql = "SELECT * FROM cheques WHERE FEC_RECH IS NOT NULL AND FEC_RECH <> '0000-00-00' AND COB_RECH IS NULL";
